...
# Define number of cores to be used in parallel. For best performance, the number of libraries to process x the number of cores should be less or equal than the total cores available in the computing server. e.g.: here we will use 20 cores x 4 libraries = 80 cores
cores <- 3
