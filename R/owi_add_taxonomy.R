## Script for adding higher taxonomy annotation (ranks higher than order) to an ecotag annotated file
## The script will read a fasta file annotated with ecotag
## And will take the information for class, phylum, kingdom and superkingdom from external CSV files, defined by the user.
## These files must be called: order.complete.csv, family_to_order.csv and genus_to_family.csv
## These files must be located in the folder tax_dir (argument to the function)
## By Owen S. Wangensteen - Project Metabarpark  2016

owi_add_taxonomy =  function(filefasta,tax_dir) {
  # filefasta must be a fasta file (from ecotag)
  # tax_dir must not be finished in /
